...
## Integrate a Scaleway bucket with Postput

### Create it with config files
Copy/paste the [`custom-scaleway.json` ](custom-scaleway.json) config file into the [`data/storage/custom`](https://github.com/postput/api/tree/master/data/storage/custom) directory, then change secret values accordingly.
